...
const integrations: IIntegrationData[] = [
  {
    ...
    integrationImage:
      "https://asset.brandfetch.io/idPfQccWRj/idZcHaRy4-.jpeg?updated=1635901775059",
    isConnected: false,
  },
];
...
export function Profile(props: Props) {
  ...
  function isIntegrationConnected(
    userIntegrations: Integration[],
    standardIntegrationName: string
  ) {
    return userIntegrations?.some(
      (integration) => integration.type === standardIntegrationName
    );
  }
