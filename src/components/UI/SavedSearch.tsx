    ...
    <div className='p-3 border border-gray-600 rounded-lg shadow-lg'>
      <div>
        ...
        <p className='text-gray-500 text-sm italic'>Searched
          at: {new Date(props.savedSearch.createdAt).toLocaleString()}</p>
      </div>
      <div className='mt-3'>
        <Modal modalButtonText='View Result Output'
          modalName={`${props.savedSearch.query}-query-output-modal-${new Date(props.savedSearch.createdAt).toLocaleTimeString()}`} modalSize='lg'>
          <div>
